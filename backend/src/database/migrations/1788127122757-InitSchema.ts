...
export class InitSchema1788127122757 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "transactions" ("id" SERIAL NOT NULL, "description" character varying NOT NULL, "amount" numeric(12,2) NOT NULL, "date" date NOT NULL, "type" "public"."transactions_type_enum" NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "user_id" integer NOT NULL, "tag_id" integer, CONSTRAINT "CHK_62aa055cd540df8774499ba22b" CHECK ("amount" > 0), CONSTRAINT "PK_a219afd8dd77ed80f5a862f1db9" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_01027966b386ed85d750f732fb" ON "transactions" ("user_id", "tag_id") `);
        ...
        await queryRunner.query(`CREATE TABLE "goals" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "target_amount" numeric(12,2) NOT NULL, "deadline" date, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "user_id" integer NOT NULL, "tag_id" integer, CONSTRAINT "CHK_90d26d4d8033fc0511c438262e" CHECK ("target_amount" > 0), CONSTRAINT "PK_26e17b251afab35580dff769223" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "goals" ADD CONSTRAINT "FK_745cd3feeafb057c4b585d900a5" FOREIGN KEY ("tag_id") REFERENCES "categories"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "goals" DROP CONSTRAINT "FK_745cd3feeafb057c4b585d900a5"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_01027966b386ed85d750f732fb"`);
